 <?php get_header(); ?>
  ...
  <div class="row reservation_head_bg wow fadeIn">
    <div class="col-sm-12 col-lg-12 col-md-12 text-center">
     ...
     <p class="reservation_tile">Reservaciones</p>
    </div>
  </div>
...
<div class="img_menu thumbnail">
  ...
  <img src="<?php echo $img_table['url']; ?>"  alt="Mesas" class="image_reservation">
      ...
      <?php endif;
      echo "<a type='button'class='btn btn-outline-light reservation_btn_table' href='#' >".$table_name_1."</a>";  
      echo "</div>";
      echo "<div class='text_reservation'>";
      echo "<p>Capacidad:".$table_capacity_1."</p>";
  echo "</div>";
 ?>
  </div>
</div>
...
<?php
 ...
 $table_capacity_2=get_post_meta( get_the_ID( ), 'table_capacity_2', true );
  ...
  echo "</div>";
  echo "<div class='text_reservation'>";
     echo "<p>Capacidad:".$table_capacity_2."</p>";
  echo "</div>";
 ?>
  </div>
</div>
...
<div class="img_menu thumbnail">
  ...
  echo "</div>";
  echo "<div class='text_reservation'>";
     echo "<p>Capacidad:".$table_capacity_3."</p>";
  echo "</div>";
 ?>
  </div>
</div>
...
<div class="img_menu thumbnail">
  ...
  echo "</div>";
  echo "<div class='text_reservation'>";
     echo "<p>Capacidad:".$table_capacity_4."</p>";
  echo "</div>";
 ?>
  </div>
</div>
...
<div class="img_menu thumbnail">
  ...
  echo "</div>";
  echo "<div class='text_reservation'>";
     echo "<p>Capacidad:".$table_capacity_5."</p>";
  echo "</div>";
 ?>
  </div>
</div>
...
<div class="img_menu thumbnail">
  ...
  echo "</div>";
  echo "<div class='text_reservation'>";
     echo "<p>Capacidad:".$table_capacity_6."</p>";
  echo "</div>";
 ?>
  </div>
</div>
...
<div class="img_menu thumbnail">
  ...
  echo "</div>";
  echo "<div class='text_reservation'>";
     echo "<p>Capacidad:".$table_capacity_7."</p>";
  echo "</div>";
 ?>
  </div>
</div>
...
<div class="img_menu thumbnail">
  ...
  echo "</div>";
  echo "<div class='text_reservation'>";
     echo "<p>Capacidad:".$table_capacity_8."</p>";
  echo "</div>";
 ?>
  </div>
</div>
...
<div class="img_menu thumbnail">
  ...
  echo "</div>";
  echo "<div class='text_reservation'>";
     echo "<p>Capacidad:".$table_capacity_9."</p>";
  echo "</div>";
 ?>
  </div>
</div>
  ...
  <div class="form-row mb-3">
   <div class="col-md-4"></div>
    ...
    <div class="col-md-2">
      <label for="validationReservation04">Numero de Telefono</label>
  ...
  <div class="form-row mb-2">
      <div class="col-md-4"></div>
   <div class="col-md-2">
    <label for="formControlSelect1">Numero de Mesa</label>
    ...
    <div class="mx-auto" style="width:200px;"><button class="btn btn-primary subForm" type="submit" action="#">Enviar</button></div>
    </div>
</form>
  </div>
