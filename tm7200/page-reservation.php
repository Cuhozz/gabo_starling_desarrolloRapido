 ...
 ?>
  ...
  <div class="form-row">
    ...
    <div class="col-md-2 mb-3">
      ...
      <input type="text" class="form-control is-invalid" id="validationReservation01" placeholder="First name" value="" required>
    </div>
    <div class="col-md-2 mb-3">
      <label for="validationReservation02">Last name</label>
      <input type="text" class="form-control is-invalid" id="validationReservation02" placeholder="Last name" value="" required>
    </div>
    <div class="col-md-4"></div>
  </div>
  <div class="form-row mb-3">
   <div class="col-md-4"></div>
    <div class="col-md-2">
      ...
      <input type="text" class="form-control is-invalid" id="validationReservation03" placeholder="" required>
    </div>
    <div class="col-md-2">
      <label for="validationReservation04">Phone number</label>
      <input type="text" class="form-control is-invalid" id="validationReservation04" placeholder="Phone number" required>
    </div>
    <div class="col-md-4"></div>
  </div>
