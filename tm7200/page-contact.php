...
<div class="row">
    <div class="col-12 welcomePages">
        ...
        <div class="captionWelcome">
            <h1>Contact Us!</h1>
            <h4 class="mt-3">We are glad to serve you</h4>
        </div>
    </div> 
</div>
...
<!-- Form Section -->
<form class="mb-5 mt-4 formContact">
    ...
    <div class="form-row mb-3">
        ...
        <div class="col-xs-4 col-md-5 col-xl-2 mb-3">
            ...
            <input type="text" class="form-control" id="validationServer03" placeholder="example@mail.com" required>
        </div>
        <div class="col-xs-4 col-md-5 col-xl-2 mb-3">
            <label for="validationServer04">Phone number</label>
            <input type="text" class="form-control" id="validationServer04" placeholder="Phone number" required>
        </div>
        <div class="col-xs-2 col-md-1 col-xl-4"></div>
    </div>
...
<div class="row mt-4 mb-3"> 
    <div class="col-12 closeContact">
        <h2>Or visit us on our different locations</h2>
    </div>
</div>
